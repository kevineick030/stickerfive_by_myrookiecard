    ...
    "slots": [
      {
        ...
        "anchors": {
          "eye_line_ratio": 0.38,
          "head_height_ratio": 0.36,
          "center_x_ratio": 0.5,
          "tolerance_ratio": 0.02,
          "head_top_ratio": 0.035,
          "note": "Verankert wird an Scheitel und Kopfhoehe - zwei Groessen, die sich aus der Freistellmaske direkt messen lassen. Die frueher benutzte Augenlinie war geschaetzt (45 % der Kopfhoehe) und liegt bei voluminoesem Haar tatsaechlich bei ueber 60 %; dann rutscht der ganze Koerper. eye_line_ratio bleibt als Sollwert fuer die Pruefung stehen, steuert aber die Platzierung nicht mehr."
        },
        ...
        "derived_requirements": {
          "head_height_mm_on_card": 18.0,
          "min_head_height_px": 213,
          ...
          "min_image_width_per_head_height": 2.944,
          "min_above_eye_per_head_height": 1.056,
          "min_below_eye_per_head_height": 1.722,
